...
- **Model**: `Qwen/Qwen2.5-TTS-3B`（デフォルト）/ `Qwen/Qwen2.5-TTS-7B`
- **Docs**: <https://huggingface.co/Qwen/Qwen2.5-TTS-3B>
...
| モデル | VRAM | 品質 |
|--------|------|------|
| `Qwen/Qwen2.5-TTS-3B` | ~8GB | 標準 |
| `Qwen/Qwen2.5-TTS-7B` | ~16GB | 高品質 |
